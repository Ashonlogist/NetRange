...
`netrange.ashonlogist.website` -> Environment -> add:
- `SUPABASE_URL`
...
`https://netrange.ashonlogist.website` -- phones and your laptop browser alike --
reads and writes the same shared dataset. No more disk wipes, no more "only
I can see my scans."

## Verify the connection

After deploying, request `https://netrange.ashonlogist.website/api/health`. A healthy
